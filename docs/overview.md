---
title: Cegid ORLI Connector Overview
...
# Cegid ORLI Connector Overview

The Cegid ORLI Connector enables OpCon to automate and monitor jobs within the Cegid ORLI commercial management application. The connector runs as a Java program under the Windows Agent, using a Java runtime supplied by the installer, and receives job definitions passed as arguments by OpCon at run time.
...
The connector supports five operations. You select one of them in the **Operation** field of the job definition:
